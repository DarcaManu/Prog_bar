...
public class gestoreFile {
    ...
    public void mostraListinoPrezzi() {//stampa a video il listino prezzi caricato dal csv
        ArrayList<String[]> listino = caricaListinoPrezzi();  // legge il CSV
        System.out.println("\n=== LISTINO PREZZI ===");
        for (String[] voce : listino) {
            System.out.println(String.join(" | ", voce));  // stampa "Colazione | Cappuccino | 1.80 | COL-001"
        }
        System.out.println("=====================");
    }
