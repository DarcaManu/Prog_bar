...
public class PanelOrdinazioni extends JPanel {
    ...
    public PanelOrdinazioni(CodaOrdini codaCondivisa, GestoreFile gestoreCondiviso) {
        ...
        titolo.setFont(new Font("Arial", Font.BOLD, 18));//cambia font e dimensione del titolo
        north.add(titolo);
        ...
        JOptionPane.showMessageDialog(null,"Ordine inserito: Tavolo " + numeroTavolo +", " + prodotto + ", x" + quantita);
        });
